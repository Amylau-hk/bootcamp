public class DemoOverloading {
  ...
  // able to declare one value or non value
  ...
  // Duplicate method, even if different return type
  ...
  // Java will treat as different method if the type position is changed
