public class WrapperClassDemo {
  public static void main(String[] args) {
    ...
    // value below 127, the object will not new a new object if the value is the same

    String s2 = "abc";
    String s3 = "abc";
    System.out.println(s2 == s3); // true, string pool
    String s4 = new String("abc");
    System.out.println(s2 == s4); // false, because s4 is new String, the object will create a new one
