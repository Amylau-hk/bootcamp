...
public class PriorityQueueDemo {
  public static void main(String[] args) {
    ...
    // while
    while (!pq.isEmpty()){
      System.out.println(pq.poll()); // complete sorting when you call polll() method...
    }
    // aax, abc, bbb, def
    ...
    PriorityQueue<Integer> pq4 = new PriorityQueue<>(new SortByInteger());
    pq4.add(Integer.valueOf(100));
    pq4.add(Integer.valueOf(-40));
    pq4.add(Integer.valueOf(9));
    pq4.add(Integer.valueOf(105));
