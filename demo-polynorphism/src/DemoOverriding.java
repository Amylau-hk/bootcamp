public class DemoOverriding { // dynamic polymorphism (run-time)
  ...
  public static void main(String[] args) {
    ...
    animal.walk(); // compile-time checks the scope of the object, but not the implimentation.
    // animal.run(); // compile error, because Animal.class has walk() ONLY.

    // During rumtime, the cat object is created in heap memory, 
    // then object ref "animal" will point to cat object and execute walk() method.
    // That is Cat.walk()
    ...
    // During rumtime, the animal object is created in heap memory, 
    // then object ref "animal2" will point to animal object and execute walk() method.
    // That is Animal.walk()
