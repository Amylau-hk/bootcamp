public class DemoCharSequence {
  public static void main(String[] args) {
    ...
    // 左邊scope (less methods can be use) smaller than 右手邊

    // String s2 = cs; // Why unable to convert to String from CharSequence?
    // Compiler concern the type of "cs" ONLY
    // Compile time cannot realize the actual object refernce by "cs"
    
    // Both Parent class and Interface relationship can apply downcasting
    String s2 = (String) cs; // Solution
    // During comile-time, we don't guarantee if the casting will be sucessful.
    // as we dont know whether the type of "cs" can be casting
    ...
    // 由CharSequence 放返出來, 所以用到String methods
    ...
    // System.out.println(cs3.reverse()); // error

    StringBuilder sb2 = (StringBuilder) cs; 
    // run-time error, "cs" refer to String object, while object refernce b2 is StringBuilder
