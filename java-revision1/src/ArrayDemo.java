public class ArrayDemo {
  public static void main(String[] args) {
    ...
    Integer[] integers = new Integer[] {1, 2, 3}; // upcast, 1 -> Integer Object with value 1
    // Answer: 4 objects in total
    // 1. Array Object
    // 2. Integer Object with value 1
    // 3. Integer Object with value 2
    // 4. Integer Object with value 3
    System.out.println(integers[2]); // 3, integer[2] -> storing the address of "Integer Object with value 3"
