...
public class Superman extends Person implements Flyable, PowerUp{
  ...
  public static void main(String[] args) {
    ...
    // During complie time, p1 cannot fly(), because p1 is declared by Person, which can call the instand method from Person.class ONLY
    ...
    // From programming perspective, if you want to eliminate the risk, you can use instanceOf
    Superman s2;
